...
//    @IBOutlet weak var hInput: NSTextField!
    ...
    @IBAction func runBtnClicked(_ sender: Any) {
        ...
        if k == 1 && found {
            ...
            Can't find an extremum or initial point is placed in
            the right-of-solution X*. Note: The right-of-side range
            of solution x* is a forbidden area. Try to revice
            initial point to check validaty of the value x0
            """
